...
LDLIBSOPTIONS=-lcaethernet -lcafont -lcafs -lcakms -lcalcd -lcamodem -lcapmodem -lcaprt -lcartc -lcauart -lcauldpm -lcausbh -lcagsm -lcabarcode -lpthread -ldl -lcaclvw -lcatls -lctosapi -lz -lssl -lcrypto -lcurl -lfreetype -lxml2 -lcaemvl2 -lcasqlite -lcaxml -lv5smultiap -lv3_libepadso -lv5scfgexpress -lbluetooth -lcaclvw -lcaemvl2 -lcaemvl2 -lcaclentry -lcaclmdl -lcaemvl2ap
...
${OBJECTDIR}/ECR/ECRTrans.o: ECR/ECRTrans.c 
	...
	$(COMPILE.c) -O2 -I/cygdrive/C/Program\ Files/Castles/VEGA5000S/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA5000S/include -o ${OBJECTDIR}/ECR/ECRTrans.o ECR/ECRTrans.c

${OBJECTDIR}/Utils/Utils.o: Utils/Utils.c 
	${MKDIR} -p ${OBJECTDIR}/Utils
	$(COMPILE.c) -O2 -I/cygdrive/C/Program\ Files/Castles/VEGA5000S/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA5000S/include -o ${OBJECTDIR}/Utils/Utils.o Utils/Utils.c

${OBJECTDIR}/ECR/MultiAptrans.o: ECR/MultiAptrans.c 
	${MKDIR} -p ${OBJECTDIR}/ECR
	$(COMPILE.c) -O2 -I/cygdrive/C/Program\ Files/Castles/VEGA5000S/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA5000S/include -o ${OBJECTDIR}/ECR/MultiAptrans.o ECR/MultiAptrans.c

${OBJECTDIR}/Main/ECRMain.o: Main/ECRMain.c 
	${MKDIR} -p ${OBJECTDIR}/Main
	$(COMPILE.c) -O2 -I/cygdrive/C/Program\ Files/Castles/VEGA5000S/include -I/cygdrive/C/Program\ Files\ \(x86\)/Castles/VEGA5000S/include -o ${OBJECTDIR}/Main/ECRMain.o Main/ECRMain.c
